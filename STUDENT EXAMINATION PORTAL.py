...
try:
   ...
   import matplotlib.pyplot as plt
path='C:/PythonProgrammingProject_n
print('-**50)


#All the Functions used Throughout the
def loading_screen0:
   for i in range(10):
...
def grade(num):
    if num>=90:
        ...
        return("Extremely poor perfomance... You have Failed the Exam and got F.")
...
def choice(stream):
    if stream.lower()=='cse' or stream.lower()=='cseai' or stream.lower()=='cseaiml' or stream.lower()=='cseaiml' or stream.lower()=='cseiotcsbs':
